  ...
  lists : [
    {
      ...
      list: [
        ...
        { title: "Harrow", acquisition: "Chains of Harrow(Quest)"},
      	{ title: "Hydroid Prime", acquisition: "Vaulted", vaulted: true, mr: 5 },
        { title: "Gara", acquisition: "Saya's Vigil(Quest)", components: "Bounties" },
        { title: "Mirage Prime", acquisition: "Relic", mr: 8 },
        { title: "Zephyr Prime", acquisition: "Vaulted", vaulted: true, mr: 6 },
        { title: "Khora", acquisition: "Sanctuary Onslaught(Game Mode)"},
        { title: "Chroma Prime", acquisition: "Vaulted", vaulted: true, mr: 6 },
        { title: "Excalibur Umbra", acquisition: "The Sacrifice (Quest)", mr: 0 },
        { title: "Limbo Prime", acquisition: "Vaulted", vaulted: true, mr: 4 },
        { title: "Revenant", acquisition: "Mask of the Revenant (Quest)", mr: 0 },
        { title: "Garuda", acquisition: "Vox Solaris (Quest)", mr: 0 },
        { title: "Mesa Prime", acquisition: "Vaulted", vaulted: true, mr: 2 },
        { title: "Baruuk", acquisition: "Little Duck (Vox Solaris Syndicate)", mr: 0 },
        { title: "Hildryn", acquisition:"Little Duck", components: "Exploiter Orb", mr: 0 },
        { title: "Equinox Prime", acquisition: "Vaulted", vaulted: true, mr: 5 },
        { title: "Atlas Prime", acquisition: "Relic", mr: 0 },
        { title: "Gauss", acquisition: "Market", components: "Disruption (Sedna)", mr: 0 },
        { title: "Grendel", acquisition: "Market", components: "Arbitration Honors vendor", mr: 0 },
        { title: "Inaros Prime", acquisition: "Relic", mr: 0},
        { title: "Ivara Prime", acquisition: "Relic", mr: 0 },
        { title: "Lavos", acquisition: "Father (Entranti)", mr: 0 },
        { title: "Nezha Prime", acquisition: "Relic", mr: 0 },
        { title: "Octavia Prime", acquisition: "Relic", mr: 0 },
        { title: "Protea", acquisition: "The Deadlock Protocol (Quest)", components: "Granum Void", mr: 0 },
        { title: "Titania Prime", acquisition: "Relic", mr: 2 },
        { title: "Wisp", acquisition: "Ropalolyst", mr: 0 },
        { title: "Wukong Prime", acquisition: "Relic", mr: 5 },
        { title: "Xaku", acquisition: "Heart of Deimos (Quest)", components: "Cambion Drift (Bounties)", mr: 0},
      ],
    },
    {
      title : "Primaries",
      list: [
        ...
        { title: "Tiberon Prime", acquisition: "Vaulted", vaulted: true, mr: 14 },
        { title: "Veldt", acquisition: "Tenno Lab", lab: "Tenno Lab", mr: 8 },
        { title: "Rubico Prime", acquisition: "Vaulted", vaulted: true, mr: 12 },
        ...
        { title: "Stradavar Prime", acquisition: "Vaulted", vaulted: true, mr: 12 },
        { title: "Acceltra", acquisition: "Demolisher Infested", mr: 8 },
        { title: "Basmu", acquisition: "Operation: Orphix Venom", mr: 11 },
        { title: "Bubonico", acquisition: "Tenno Lab", lab: "Bio Lab", mr: 13 },
        { title: "Carmine Penta", acquisition: "Warframe (China)", mr: 6 },
        { title: "Cedo", acquisition: "Father (Entranti)", mr: 8 },
        { title: "Corinth Prime", acquisition: "Relic", mr: 14 },
        { title: "Fulmin", acquisition: "Market", mr: 8 },
        { title: "Glaxion Vandal", acquisition: "Baro Ki'Teer", mr: 12 },
        { title: "Komorex", acquisition: "Tenno Lab", lab: "Energy Lab", mr: 8 },
        { title: "Kuva Bramma", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Chakkhurr", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Drakgoon", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Hind", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Karak", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Kohm", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Ogris", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Quartakk", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Tonkor", acquisition: "Kuva Lich", mr: 13 },
        { title: "Opticor Vandal", acquisition: "Thermia Fractures", mr: 14 },
        { title: "Panthera Prime", acquisition: "Relic", mr: 14 },
        { title: "Proboscis Cernos", acquisition: "Market", mr: 15 },
        { title: "Quellor", acquisition: "Blite Captain/Glacik Commander/Lektro Commander/Pyr Captain", mr: 12 },
        { title: "Shedu", acquisition: "Erra (Quest)", components: "Symbilysts",  mr: 13 },
        { title: "Sporothrix", acquisition: "Arcana Isolation Vault Bounties", mr: 13 },
        { title: "Stahlta", acquisition: "Jackal", components: "Granum Void",  mr: 10 },
        { title: "Tenora Prime", acquisition: "Relic", mr: 14 },
        { title: "Trumna", acquisition: "Father (Entrati)", mr: 13 },
        { title: "Zhuge Prime", acquisition: "Relic", mr:  14 },
        { title: "Baza Prime", acquisition: "Relic", mr:  14 },
      ],
    },
    {
      title : "Secondaries",
      list: [
        ...
        { title: "Aklex Prime", acquisition: "Baro Ki'Teer", mr: 15 },
        ...
        { title: "Vasto Prime", acquisition: "Vaulted, Baro", vaulted: true, mr: 10 },
        ...
        { title: "Ballistica Prime", acquisition: "Vaulted", vaulted: true, mr: 14 },
        ...
        { title: "Pyrana Prime", acquisition: "Vaulted", vaulted: true, mr: 13 },
        ...
        { title: "Akjagara Prime", acquisition: "Vaulted", vaulted: true, mr: 12},
        { title: "Plinx", acquisition: "Market", mr: 6 },
        { title: "Akarius", acquisition: "Demolisher Infested", mr: 8 },
        { title: "Aksomati Prime", acquisition: "Relic", mr: 12 },
        { title: "Akvasto Prime", acquisition: "Baro Ki'Teer", mr: 12 },
        { title: "Athodai", acquisition: "Twitch", mr: 10 },
        { title: "Catabolyst", acquisition: "Bio Lab", lab: "Bio Lab", mr: 11 },
        { title: "Cyanex", acquisition: "Energy Lab", lab: "Energy Lab", mr: 8 },
        { title: "Kuva Brakk", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Kraken", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Nukor", acquisition: "Kuva Lich", mr: 13 },
        { title: "Kuva Seer", acquisition: "Kuva Lich", mr: 15 },
        { title: "Kuva Twin Stubbas", acquisition: "Kuva Lich", mr: 13 },
        { title: "Pandero Prime", acquisition: "Relic", mr: 14 },
        { title: "Prisma Twin Gremlins", acquisition: "Baro Ki'Teer", mr: 11 },
        { title: "Quatz", acquisition: "Market", mr: 9 },
        { title: "Sepulcrum", acquisition: "Father (Entrati)", mr: 14 },
        { title: "Spectra Vandal", acquisition: "Veil Proxima Empyrean", mr: 10 },
        { title: "Velox", acquisition: "Market", components: "Granum Void", mr: 8 },
        { title: "Zakti Prime", acquisition: "Relic", mr: 14 },
        { title: "Zymos", acquisition: "Father (Entranti)", mr: 11 },
      ],
    },
    {
      title : "Melee",
      list: [
        ...
        { title: "Nami Skyla Prime", acquisition: "Vaulted", vaulted: true, mr: 11 },
        ...
        { title: "Kronen Prime", acquisition: "Vaulted", vaulted: true, mr: 8 },
        { title: "Dual Keres", acquisition: "Market", mr: 7 },
        { title: "Destreza Prime", acquisition: "Vaulted", vaulted : true, mr: 10 },
        { title: "Gram Prime", acquisition: "Vaulted", vaulted: true, mr: 14 },
        ...
        { title: "Redeemer Prime", acquisition: "Vaulted", vaulted: true, mr: 10 },
        ...
        { title: "Tipedo Prime", acquisition: "Vaulted", vaulted: true, mr: 10 },
        { title: "Arum Spinosa", acquisition: "Arcana Isolation Vault Bounties", mr: 11 },
        { title: "Cadus", acquisition: "Market", mr: 0 },
        { title: "Ceti Lacera", acquisition: "Operation: Orphix Venom", mr: 12 },
        { title: "Guandao Prime", acquisition: "Relic", mr: 12 },
        { title: "Karyst Prime", acquisition: "Relic", mr: 12 },
        { title: "Keratinos", acquisition: "Father (Entrati)", mr: 9 },
        { title: "Korrudo", acquisition: "Tusk Thumper Bull/Tusk Thumper Doma", mr: 9 },
        { title: "Kuva Shildeg", acquisition: "Kuva Lich", mr: 13 },
        { title: "Masseter", acquisition: "Tenno Lab", lab: "Tenno Lab", mr: 8 },
        { title: "Ninkondi Prime", acquisition: "Relic", mr: 14 },
        { title: "Pangolin Prime", acquisition: "Relic", mr: 14 },
        { title: "Pathocyst", acquisition: "Zealoid Prelate", mr: 9 },
        { title: "Pennant", acquisition: "Blite Captain/Glacik Commander/Lektro Commander/Pyr Captain", mr: 7 },
        { title: "Prisma Machete", acquisition: "Baro Ki'Teer", mr: 7 },
        { title: "Pulmonars", acquisition: "Market", mr: 11 },
        { title: "Quassus", acquisition: "Cambion Drift Bounties", mr: 8 },
        { title: "Stropha", acquisition: "Jackal", components: "Granum Void", mr: 10 },
        { title: "Tekko Prime", acquisition: "Relic", mr: 12 },
        { title: "Vitrica", acquisition: "Nihil", mr: 13 },
        { title: "Xoris", acquisition: "The Deadlock Protocol (Quest)", mr: 4 },
      ],
    },
    {
      title : "Sentinels",
    ...
    },
    {
      ...
      list: [
        { title: "Artax", usage: "Taxon", acquisition: "Sentinel", mr: 0 },
        ...
        { title: "Sweeper Prime", usage: "Carrier Prime", acquisition: "Sentinel", mr: 0 },
        { title: "Vulklok", usage: "Diriga", acquisition: "Sentinel", mr: 0 },
    ...
    },
    {
      ...
      list: [
        ...
        { title: "Vizier Predasite", acquisition: "Incubator Segment" },
        { title: "Pharaoh Predasite", acquisition: "Incubator Segment" },
        { title: "Medjay Predasite", acquisition: "Incubator Segment" },
      ],
    },
    {
      title : "Kavats",
      list: [
        ...
        { title: "Venari", acquisition: "Khora" },
        { title: "Vasca Kavat", acquisition: "Khora" },
        { title: "Sly Vulpaphyla", acquisition: "Khora" },
        { title: "Crescent Vulpaphyla", acquisition: "Khora" },
        { title: "Panzer Vulpaphyla", acquisition: "Khora" },
      ],
    },
    {
      title : "MOAs",
    ...
    },
    {
      ...
      list: [
        ...
        { title: "Odonata Prime", acquisition: "Vaulted, Baro", vaulted: true },
      ],
    },
    {
      title : "Arch-melee",
    ...
    },
    {
      ...
      list: [
        ...
        { title: "Cortege", acquisition: "Necraloid" , mr : 14},
        { title: "Kuva Ayanga", acquisition: "Kuva Lich", mr: 13 },
        { title: "Mausolon", acquisition: "After claiming any Necramech from the foundry", mr: 14 },
        { title: "Morgha", acquisition: "Necraloid", mr: 15 },
        { title: "Prisma Dual Decurion", acquisition: "Baro Ki'Teer", mr: 10 }
      ],
    },
    {
      title : "Amps",
    ...
    },
    {
      title : "Zaws",
      list: [
        { title: "Balla", acquisition: "Hok's Anvil"},
        { title: "Ooltha", acquisition: "Hok's Anvil"},
        { title: "Kronsh", acquisition: "Hok's Anvil"},
        { title: "Dehtat", acquisition: "Hok's Anvil"},
        { title: "Mewan", acquisition: "Hok's Anvil"},
        { title: "Cyath", acquisition: "Hok's Anvil"},
        { title: "Plague Keewar", acquisition: "Operation: Plague Star"},
        { title: "Plague Kripath", acquisition: "Operation: Plague Star"},
        { title: "Sepfahn", acquisition: "Hok's Anvil"},
        { title: "Rabvee", acquisition: "Hok's Anvil"},
        { title: "Dokrahm", acquisition: "Hok's Anvil"},
      ],
    },
    {
      title : "Kitguns",
      list: [
        { title: "Catchmoon", acquisition: "Rude Zuud (Fortuna)" },
        { title: "Gaze", acquisition: "Rude Zuud (Fortuna)" },
        { title: "Rattleguts", acquisition: "Rude Zuud (Fortuna)" },
        { title: "Tombfinger", acquisition: "Rude Zuud (Fortuna)" },
        { title: "Sporelacer", acquisition: "Father (Necralisk)" },
        { title: "Vermisplicer", acquisition: "Father (Necralisk)" },
      ],
    },
  ]
};
