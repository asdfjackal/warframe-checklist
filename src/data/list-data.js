  ...
  lists : [
    {
      ...
      list: [
        ...
        { title: "Ember Prime", acquisition: "Relic",   },
        ...
        { title: "Frost Prime", acquisition: "Relic",   },
        ...
        { title: "Loki Prime", acquisition: "Relic",   },
        { title: "Mag", acquisition: "Market", components: "The Sergeant" },
        { title: "Mag Prime", acquisition: "Relic",   },
        ...
        { title: "Nekros Prime", acquisition: "Relic",  mr: 0 },
        ...
        { title: "Nova Prime", acquisition: "Relic",   },
        { title: "Nyx", acquisition: "Market", components: "Phorid" },
        { title: "Nyx Prime", acquisition: "Relic",   },
        ...
        { title: "Rhino Prime", acquisition: "Relic",   },
        ...
        { title: "Valkyr Prime", acquisition: "Relic",  mr: 0 },
        ...
        { title: "Volt Prime", acquisition: "Relic",   },
        ...
        { title: "Gauss", acquisition: "Kappa Disruption Sedna", mr: 0 },
        { title: "Atlas Prime", acquisition: "Relic", mr: 0 },
        { title: "Grendel", acquisition: "Arbitration Store", mr: 0 },
        { title: "Ivara Prime", acquisition: "Relic", mr: 0 },
        { title: "Titania Prime", acquisition: "Relic", mr: 2 },
        { title: "Protea", acquisition: "Granum Void", mr: 0 },
        { title: "Inaros Prime", acquisition: "Relic", mr: 0 },
        { title: "Xaku", acquisition: "Deimos Bounty", mr: 0 },
        { title: "Nezha Prime", acquisition: "Relic", mr: 0 },
        { title: "Lavos", acquisition: "Father (Deimos Nekralisk)", mr: 0 },
        { title: "Octavia Prime", acquisition: "Relic", mr: 0 },
        { title: "Sevagoth", acquisition:"Call of the Tempestarii (Quest)", components: "Void Stormes", mr: 0 },
        { title: "Gara Prime", acquisition: "Relic", mr: 0 },
        { title: "Yareli", acquisition: "Waverider (Quest)", components: "Bash Lab", lab: "Bash Lab" },
      ],
    },
    {
      title : "Primaries",
      list: [
        ...
        { title: "Boar Prime", acquisition: "Relic",  mr: 11 },
        { title: "Boltor", acquisition: "Market", mr: 2 },
        { title: "Boltor Prime", acquisition: "Relic",  mr: 13 },
        ...
        { title: "Latron Prime", acquisition: "Relic",  mr: 10 },
        ...
        { title: "Soma Prime", acquisition: "Relic",  mr: 7 },
        ...
        { title: "Vectis Prime", acquisition: "Relic",  mr: 14 },
        ...
        { title: "Acceltra", acquisition: "Demolisher Infested on the Dark Sector mission Ur, Uranus", mr: 8 },
        { title: "Quellor", acquisition: "Kasio's Rest on Saturn Proxima, Flexa in Veil Proxima, or sometimes Korms Belt in Earth Proxima", mr: 12 },
        { title: "Basmu", acquisition: "Traded between players (15/07/21)", mr: 8 },
        { title: "Kuva Karak", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Kohm", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Ogris", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Tonkor", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Drakgoon", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Chakkurr", acquisition: "Kuva Litches", mr: 13 },
        { title: "Stahlta", acquisition: "Granum Void", mr: 10 },
        { title: "Proboscis Cernos", acquisition: "Market", mr: 15 },
        { title: "Bubonico", acquisition: "Bio Lab", lab:"Bio Lab", mr: 13 },
        { title: "Cedo", acquisition: "Father (Deimos Nekralisk)", mr: 8 },
        { title: "Tenet Envoy", acquisition: "Sister of Parvos", mr: 16 },
        { title: "Tenet Flux Rifle", acquisition: "Sister of Parvos", mr: 16 },
        { title: "Tenet Arca Plasmor", acquisition: "Sister of Parvos", mr: 16 },
        { title: "Kuva Hek", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Zarr", acquisition: "Kuva Litches", mr: 13 },
        { title: "Ambassador", acquisition: "Void Storms", mr: 8 },
        { title: "Tenet Tetra", acquisition: "Sister of Parvos", mr: 16 },
        { title: "Kuva Quartakk", acquisition: "Kuva Litches", mr: 13 },
        { title: "Trumna", acquisition: "Father (Deimos Nekralisk)", mr: 13 },
        { title: "Panthera prime", acquisition: "Relic", mr: 8 },
        { title: "Sporothrix", acquisition: "Isolation Vault Bounties", mr: 13 },
        { title: "Tenora Prime", acquisition: "Relic", mr: 8 },
        { title: "Carmine Penta", acquisition: "Pluto Proxima or Veil Proxima Corpus-controlled territory Derelict Freightlinkers Caches", mr: 6 },
        { title: "Astilla Prime", acquisition: "Relic", mr: 8 },
        { title: "Baza Prime", acquisition: "Relic", mr: 10 },
        { title: "Catch Moon", acquisition: "Rude Zuud (Fortuna)", mr: 0 },
        { title: "Corinth Prime", acquisition: "Relic", mr: 14 },
        { title: "Gaze", acquisition: "Rude Zuud (Fortuna)", mr: 0 },
        { title: "Glaxion Vandal", acquisition: "Baro Ki'Teer", mr: 12 },
        { title: "Kuva Bramma", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Hind", acquisition: "Kuva Litches", mr: 13 },
        { title: "Opticor Vandal", acquisition: "Baro Ki'Teer", mr: 14 },
        { title: "Rattleguts", acquisition: "Rude Zuud (Fortuna)", mr: 0 },
        { title: "Shedu", acquisition: "Erra (Quest)", components: "Symbilysts in Sentient Anomalies", mr: 13 },
        { title: "Sporelacer", acquisition: "Father (Deimos)", mr: 0 },
        { title: "Tomb Finger", acquisition: "Rude Zuud (Fortuna)", mr: 0 },
        { title: "Vermisplicer", acquisition: "Father (Deimos)", mr: 0 },
        { title: "Zhuge Prime", acquisition: "Relic", mr: 10 },
      ],
    },
    {
      title : "Secondaries",
      list: [
        ...
        { title: "Aklex Prime", acquisition: "Relic, Baro",  mr: 15 },
        ...
        { title: "Akstiletto Prime", acquisition: "Relic",  mr: 10 },
        ...
        { title: "Hikou Prime", acquisition: "Relic",  mr: 4 },
        ...
        { title: "Sicarus Prime", acquisition: "Relic",  mr: 14 },
        ...
        { title: "Spira Prime", acquisition: "Relic",  mr: 10 },
        ...
        { title: "Vasto Prime", acquisition: "Relic",  mr: 10 },
        ...
        { title: "Zylok", acquisition: "Baro Ki'Teer", mr: 6 },
        ...
        { title: "Akarius", acquisition: "Demolisher Infested on the Dark Sector mission Ur, Uranus", mr: 8 },
        { title: "Aksomati Prime", acquisition: "Relics", mr: 8 },
        { title: "Akvasto Prime", aacquisition: "Relics", mr: 8 },
        { title: "Akzani", acquisition: "Market", mr: 4 },
        { title: "Athodai", acquisition: "Venus Proxima, Empyrean", mr: 10 },
        { title: "Catabolyst", acquisition: "Bio Lab", lab: "Bio Lab", mr: 11 },
        { title: "Epitaph", acquisition: "Void Storm missions, Empyrean", mr: 8 },
        { title: "Kompressa", acquisition: "Ventkids (Fortuna)", mr: 8 },
        { title: "Kuva Brakk", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Kraken", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Nukor", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Seer", acquisition: "Kuva Litches", mr: 13 },
        { title: "Kuva Twin Stubbas", acquisition: "Kuva Litches", mr: 13 },
        { title: "Pandero Prime", acquisition: "Relics", mr: 8 },
        { title: "Prisma Twin Gremlins", acquisition: "Baro Ki'Teer", mr: 11 },
        { title: "Quatz", acquisition: "Market", mr: 9 },
        { title: "Sepulcrum", acquisition: "Father (Deimos Nekralisk)", mr: 14 },
        { title: "Spectra Vandal", acquisition: "Veil Proxima, Empyrean, Grineer, Abandoned Derelicts", mr: 10 },
        { title: "Kitgun (Sporelacer)", acquisition: "Father (Deimos Nekralisk)", mr: 0 },
        { title: "Tenet Cycron", acquisition: "Sister of Parvos", mr: 14 },
        { title: "Tenet Detron", acquisition: "Sister of Parvos", mr: 14 },
        { title: "Tenet Diplos", acquisition: "Sister of Parvos", mr: 14 },
        { title: "Tenet Spirex", acquisition: "Sister of Parvos", mr: 14 },
        { title: "Velox", acquisition: "Energy Lab", lab: "Energy Lab", mr: 8 },
        { title: "Kitgun (Vermisplicer)", acquisition: "Father (Deimos Nekralisk)", mr: 0 },
        { title: "Zakti Prime", acquisition: "Relics", mr: 14 },
        { title: "Zymos", acquisition: "Father (Deimos Nekralisk)", mr: 11 },
      ],
    },
    {
      title : "Melee",
      list: [
        ...
        { title: "Ankyros Prime", acquisition: "Relic",   },
        { title: "Atterax", acquisition: "Market", mr: 2 },
        { title: "Bo", acquisition: "Market" },
        { title: "Bo Prime", acquisition: "Relic",  mr: 5 },
        ...
        { title: "Dakra Prime", acquisition: "Relic",  mr: 6 },
        ...
        { title: "Glaive Prime", acquisition: "Relic",  mr: 10 },
        ...
        { title: "Nikana Prime", acquisition: "Relic",   },
        ...
        { title: "Reaper Prime", acquisition: "Relic",  mr: 2 },
        ...
        { title: "Scindo Prime", acquisition: "Relic",  mr: 4 },
    ...
    },
    {
      ...
      list: [
        ...
        { title: "Wyrm Prime", acquisition: "Relic",   },
    ...
    },
    {
      ...
      list: [
        ...
        { title: "Odonata Prime", acquisition: "Relic",   },
      ],
    },
    {
      title : "Arch-melee",
